...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="/resources/css/bootstrap-editable.css" />
	...
	<body>
										...
										<div class="col-xs-12 col-sm-3 center">
											<div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="/resources/avatars/profile-pic.jpg" />
												</span>
										...
										<div class="col-xs-12 col-sm-9">
											<div class="center">
												...
												<span class="btn btn-app btn-sm btn-pink no-hover">
													...
													<br />
													<span class="line-height-1 smaller-90"> 被关注 </span>
												</span>
												...
												<span class="btn btn-app btn-sm btn-grey no-hover">
													...
													<br />
													<span class="line-height-1 smaller-90"> 分类 </span>
												</span>
												...
												<span class="btn btn-app btn-sm btn-success no-hover">
													...
													<br />
													<span class="line-height-1 smaller-90"> 私信 </span>
												</span>
												...
												<span class="btn btn-app btn-sm btn-primary no-hover">
													...
													<br />
													<span class="line-height-1 smaller-90"> 回复 </span>
												</span>
											</div>
											...
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="username">小明</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<span class="editable" id="city">上海</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="about">我还是原来的我，不一样的烟火</span>
													</div>
												</div>
											</div>
		...
		<script src="/resources/js/jquery.hotkeys.min.js"></script>
		...
		<script src="/resources/js/x-editable/bootstrap-editable.min.js"></script>
		<script src="/resources/js/x-editable/ace-editable.min.js"></script>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$('.main-content').on('click','.editable-submit',function(){
